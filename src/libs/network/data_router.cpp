...
namespace keycap::root::network
{
    ...
    bool data_router::route_inbound(service_base& service, std::vector<uint8_t> const& data) const
    {
        bool succeeded = true;
    ...
    void data_router::route_outbound(std::vector<uint8_t> const& data) const
    {
