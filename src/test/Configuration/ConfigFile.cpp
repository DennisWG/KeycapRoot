...
TEST_CASE("Testing ConfigFile::GetOrDefault", "[ConfigFile]")
{
    ...
    SECTION("ConfigFile::GetOrDefault must return the given default value if attempting to retreive a value from empty category")
    {
    ...
    SECTION("ConfigFile::GetOrDefault must return the given default value if attempting to retreive non existant value from category")
    {
    ...
    SECTION("ConfigFile::GetOrDefault must return the given default value if attempting to retreive non existant value outside of category")
    {
